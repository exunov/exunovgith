    ...
    <section>
      <div className="md:(px-40) px-5">
        ...
        <p className="px-6 text-sm mt-4 md:(px-60 text-xl)">
          ...
          infrastructure as part of your organization's digital transformation
          journey and achieve maximum performance while reducing your monthly
          costs.
        </p>
      </div>
      <div className="bg-gray-100 mt-6 md:(text-xl py-2)space-y-2">
        <h1 className="text-center font-bold text-amber-400 mt-2 md:(mt-2 px-8 text-2xl) ">
          Managed servers offer lower costs,
          <br /> greater agility and ongoing stability.
        </h1>
        <p className=" mt-4 p-5 text-sm md:(px-60 text-xl )">
          The server management industry has witnessed a robust growth rate in
          the previous decade and is expected to grow significantly in the
          coming decades. Hence, it is essential to identify all the investment
          opportunities, upcoming market threats, limiting factors, challenges,
          market dynamics, and technological advancements to strengthen the
          presence in the server management platform industries. With Exunov
          Server Management, we will evaluate your current and future IT
          investments, application usage, and short and long term goals to see
          how our server management solutions can help the business move
          forward. Our server management strategy and readiness solution
          provides you with a consistent and interpretable set of APIs, clouds,
          and "buy" versus "build". We'll help you understand the changes you
          need to make to your existing systems to integrate with new
          technologies and compare your current managed server environment to a
...
function BodyB() {
  return (
    <div className="space-y-4 mt-4">
      <h1 className=" space-y-4 text-center text-amber-400  font-bold md:(mt-2 px-4 text-3xl)">
      ...
      <div className="p-2 mt-4 space-x-6 border-b-4 md:(py-15 mx-20 px-50)">
        ...
        <div className="ml-8 md:(pt-20) ">
          <h1 className=" text-xl font-bold mt-2">Productivity</h1>
      ...
      <div className="p-2 space-x-10 border-b-4 md:( py-15 mx-20 px-50)">
        ...
        <div className="ml-8 md:(pt-20 mml-10) ">
          <h1 className="text-xl font-bold mt-2">Time</h1>
          <p className="mt-4 text-sm font-semibold md:(text-xl)">
  ...
  return (
    <section>
      <div className="mt-8 md:(mt-20 px-50 py-5) bg-amber-800 text-white space-y-2">
        <h1 className="space-y-6 text-center text-amber-300 font-bold md:(mt-5 px-4 text-2xl)">
          Our managed server solutions
        </h1>
        <p className="px-4 md:(text-xl font-semibold mx-10)">
        ...
        <ul className="list-disc list-inside text-white p-5  md:(text-xl font-thin mx-20)">
