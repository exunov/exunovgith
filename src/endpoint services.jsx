  ...
  return (
    <section>
      <div className="md:(px-40) px-5">
        ...
        <p className="space-y-4 mt-2  text-sm md:( text-xl)">
          ...
          technology is optimized for the best results, with zero impact on its
          end use.{" "}
        </p>
      </div>
        ...
        <ul className="list-none mt-6 space-y-4 md:(text-xl)">
          ...
          <div className="flex space-x-3">
            ...
            <li className="mt-3">
              ...
              relevant devices, number under management, activity status, patch
              compliance, etc.
            </li>
          </div>
          <div className=" flex space-x-3">
            <Puce />
            <li className="mt-3">
              Performs global maintenance, such as cleaning up temporary files,
              clearing the DNS cache and cleaning up Windows disks.{" "}
            </li>
          </div>
        </ul>
      </div>
      <div className=" px-6  md:(px-60)">
        ...
        <p className="mt-4 text-sm md:(text-xl)">
          ...
          ensure that endpoints are patched and up to date. Our endpoint device
          management solution helps protect your organization with patch
          management and ensures that your users' devices are not exposed to
          operating system vulnerabilities and potential security risks.{" "}
        </p>
      </div>
      ...
      <div className="space-y-2 px-6 md:(px-60)">
        ...
        <p className=" text-sm md:(text-xl)  ">
          ...
          endpoint management includes ticket-based maintenance options for our
          users' endpoints so they can get back up and running quickly and
          efficiently.{" "}
        </p>
      </div>
    </section>
