    ...
    <section className="">
      <div className="md:(px-40) px-5">
        ...
        <p className="space-y-4 mt-4 text-sm  md:(px-50 text-xl)">
          It is necessary to ensure that your critical systems, applications and
          data are protected from loss and avoid costly downtime with managed
          data protection solutions. Risk prevention allows our customers to
          access our services, no matter what.
        </p>
        <p className="mt-4 text-sm md:(px-50 text-xl)">
          The implementation and development of Business Continuity Plans (BCP)
          has become the theme of our time. When the COVID-19 crisis broke out,
          EXUNOV was in a unique position to help companies of all sizes deal
          with this crisis.
        </p>
      </div>
      ...
      <div className="pt-4 px-6">
        ...
        <p className="space-y-4 mt-4 text-sm  md:(px-50 text-2xl)">
          By choosing a customer-centric approach to data protection solutions,
          we ensure informed and pragmatic investments in robust processes and
          technologies.
        </p>
      </div>
      <div className="pt-4 px-6">
        ...
        <p className="mt-4 text-sm md:(px-50 text-xl)">
          We are a partner capable of supporting your projects in the long term
          and we also intervene in the event of unforeseen circumstances. Our
          role is to ensure that the services are available no matter what
          happens.{" "}
        </p>
      </div>
      <div className="pt-4 px-6">
      ...
      <div className="pt-4 px-6">
        ...
        <p className="mt-4 text-sm text-center md:(text-xl)">
          Our staff has extensive experience in aligning organizations with best
